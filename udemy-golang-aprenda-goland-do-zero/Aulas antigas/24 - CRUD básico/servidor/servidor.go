...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro != nil {
		w.Write([]byte("Falha al ler o corpo da requisição"))
		return
	}
	...
	if erro != nil {
		w.Write([]byte("Erro ao inserir o usuário no banco!"))
		return
	}
...
// BuscarUsuarios retorna um usuário específico salvo no banco de dados
...
// AtualizarUsuario serve para atualizar usuarios
